#ifndef _LL_LINE_DETECTION_H_
#define _LL_LINE_DETECTION_H_
...
#endif	// _LL_LINE_DETECTION_H_

#ifdef LINE_DETECTION_IMPLEMENTATION
...
#endif	// LINE_DETECTION_IMPLEMENTATION
